    ...
    <div className='register__bg'>
      <div className="container pt-24 mx-auto flex align-middle text-center justify-center">
        <form className='rounded-lg py-6 mt-36 form__inner'>
          <h1 className='text__color text-8xl mb-6 font-bold '>Register</h1>
          <input className='form__control' type="text" name="name" id="name" placeholder='Your Name' />
          ...
          <input className='form__control' type="password" name="creatyPassword" id="creatyPassword" placeholder='Your Creaty Password' />
          ...
          <div className="flex text-2xl text-white ml-10">
            ...
            <Link className='form__login text-sky-700 ml-2' to={'/login'}>login</Link>
          </div>
        </form>
      </div>
    </div>
